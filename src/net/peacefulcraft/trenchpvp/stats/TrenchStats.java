...
public class TrenchStats {
	...
	public enum GeneralStat implements TrenchStat {
		...
		player_friendly_kills, player_deaths
	}
	public enum DemoStat implements TrenchStat {
		demoman_kills, demoman_deaths, demoman_damage_dealt, demoman_berthas_placed 
	}
	public enum HeavyStat implements TrenchStat {
		heavy_kills, heavy_deaths, heavy_damage_dealt, heavy_dusks_edge_kills, heavy_absolute_defense_usage
	}
	public enum MedicStat implements TrenchStat {
		medic_kills, medic_deaths, medic_damage_dealt, medic_damage_healed, medic_syringe_gun_kills
	}
	public enum PyroStat implements TrenchStat {
		pyro_kills, pyro_deaths, pyro_damage_dealt, pyro_inferno_axe_kills, pyro_traps_placed
	}
	public enum ScoutStat implements TrenchStat {
		scout_kills, scout_deaths, scout_damage_dealt, scout_windsong_blade_kills, scout_sling_shot_kills
	}
	public enum SniperStat implements TrenchStat {
		sniper_kills, sniper_deaths, sniper_damage_dealt, 
	...
	public enum SoldierStat implements TrenchStat {
		soldier_kills, soldier_deaths, soldier_damage_dealt, soldier_witherbringer_kills, soldier_highest_onslaught
	}
	public enum SpyStat implements TrenchStat {
		spy_kills, spy_deaths, spy_damage_dealt, spy_hidden_blade_kills, spy_speed_shot_usage, spy_kills_while_invisible
	}
}
